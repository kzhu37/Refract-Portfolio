      ...
      <main id="top">
        <section className="hero" aria-labelledby="hero-title">
          ...
          <div className="scope-banner" role="note">
            ...
            <p>
              <strong>Portfolio browser demo</strong> — Correction is limited to content inside this page. The full desktop prototype captures desktop content and renders through a separate transparent Electron overlay above other applications.
            </p>
          </div>
        </section>
          ...
          <div className="demo-layout">
            ...
            <aside className="control-panel" aria-label="Refract demonstration controls">
              ...
              <div className="control-section tracking-section">
                ...
                {trackingMode === 'eye' && (
                  <p className="tracking-note">This quick portfolio mode uses Refract’s eye-relative iris features and Kalman smoothing without the desktop app’s full 3 × 3 gaze calibration.</p>
                )}
              </div>
